    ...
    def set_freq_units(self, plot):
        ...
        self.transformer.module_report.ChangeProperty(
            [
                ...
                [
                    "NAME:Data Filter",
                    ["NAME:PropServers", plot + ":PrimarySweepDrawing"],
                    [
                        "NAME:ChangedProps",
                        ["NAME:Number Format", "Value:=", "Scientific"],
                        ["NAME:Units", "Value:=", "kHz"],
                    ],
                ],
            ]
        )
...
class TestWirewound(BaseAEDT):
    ...
    def test_05_solid_loss(self):
        ...
        reference_loss = [
            0.001791334027,
            0.0011241232529999999,
            0.00098726573489999999,
            0.00098593841609999995,
            0.0010940049879999999,
            0.001410922602,
            0.0020232734429999999,
        ]
        self.compare_loss("SolidLoss", reference_loss)
    ...
    def test_06_core_loss(self):
        ...
        """
        reference_loss = [
            0.0014199200000000001,
            0.00058693600000000003,
            0.00024258099999999999,
            0.000100207,
            4.1315400000000001e-05,
            1.6967199999999999e-05,
            6.9389800000000003e-06,
        ]
        self.compare_loss("CoreLoss", reference_loss)
...
class TestCoreEC(BaseAEDT):
    ...
    def test_03_solid_loss(self):
        ...
        reference_loss = [
            0.48166285380000001,
            0.12871921159999999,
            0.051960901009999998,
            0.034661488040000001,
            0.029949885039999999,
            0.028715741239999999,
            0.02929752683,
        ]
        self.compare_loss("SolidLoss", reference_loss)
    ...
    def test_04_core_loss(self):
        ...
        """
        reference_loss = [
            0.013777299999999999,
            0.0069939700000000004,
            0.0035386599999999999,
            0.0017938800000000001,
            0.00091125600000000005,
            0.000461817,
            0.000233544,
        ]
        self.compare_loss("CoreLoss", reference_loss)
...
class TestCoreU(BaseAEDT):
    ...
    def test_01_skins(self):
        ...
        # outside skins
        vertex_coord = self.vertex_from_edge_coord(
            (-5.230450129, 14.14550966, 10.15), "Layer2_skin_1_out_1", sort_key=2
        )
        ...
        vertex_coord = self.vertex_from_edge_coord(
            (-5.228170142, 14.04101932, 10.15), "Layer2_skin_1_skin_2_out_1", sort_key=2
        )
        ...
        # inside skins
        vertex_coord = self.vertex_from_edge_coord(
            (-5.171829858, 11.45898068, 10.15), "Layer2_skin_1_skin_2_in_1", sort_key=2
        )
        ...
        vertex_coord = self.vertex_from_edge_coord((-5.169549871, 11.35449034, 10.15), "Layer2_skin_1_in_1", sort_key=2)
